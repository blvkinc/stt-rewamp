      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-neutral-800">Create Package</h1>
              <p className="text-neutral-600">Design a custom package for your event</p>
            </div>
          </div>
          ...
          <div className="flex space-x-3">
            ...
            >
              ...
              <span>{saving ? 'Publishing...' : 'Publish Package'}</span>
            </button>
          </div>
        </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-primary-300 outline-none ${
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-primary-300 outline-none ${
                        errors.eventId ? 'border-red-300' : 'border-neutral-200'
                      }`}
                    >
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        min="0"
                        step="0.01"
                        className={`w-full pl-10 pr-4 py-3 border rounded-xl focus:ring-2 focus:ring-primary-300 outline-none ${
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        min="1"
                        className={`w-full pl-10 pr-4 py-3 border rounded-xl focus:ring-2 focus:ring-primary-300 outline-none ${
                          errors.maxGuests ? 'border-red-300' : 'border-neutral-200'
                        }`}
                      />
                    </div>
